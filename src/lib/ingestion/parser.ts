...
const HEADER_ALIASES: Record<string, KeyAlias> = Object.fromEntries(
  Object.entries({
    ...
    'aircraft makemodel': 'aircraftModel',
    ...
    dep: 'origin',
    departure: 'origin',
    'route from icao': 'origin',
    to: 'destination',
    destination: 'destination',
    arr: 'destination',
    arrival: 'destination',
    'route to icao': 'destination',
    number: 'flightNumber',
    'flight number': 'flightNumber',
    total: 'totalTime',
    'total time': 'totalTime',
    'total flight time hhmm': 'totalTime',
    duration: 'totalTime',
    hours: 'totalTime',
    pic: 'pic',
    'pic time': 'pic',
    ...
    dual: 'dual',
    instruction: 'dual',
    'dual received hhmm': 'dual',
    night: 'night',
    'night time hhmm': 'night',
    ifr: 'ifr',
    'ifr time hhmm': 'ifr',
